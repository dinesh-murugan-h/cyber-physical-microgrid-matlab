...
MODULES                 = Microgrid_with_Utility_Connection_acc.c Microgrid_with_Utility_Connection_acc_data.c rt_nonfinite.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/Microgrid_with_Utility_Connection_acc.mexa64
MAKEFILE                = Microgrid_with_Utility_Connection.mk
MATLAB_ROOT             = /usr/local/MATLAB/R2024b
ALT_MATLAB_ROOT         = /usr/local/MATLAB/R2024b
START_DIR               = /home/dinesh/documents/captsone/cyber-physical-microgrid-matlab/scada
S_FUNCTIONS_LIB         = 
NUMST                   = 5
NCSTATES                = 12
COMPUTER                = GLNXA64
...
SYSTEM_LIBS             = -L"/usr/local/MATLAB/R2024b/bin/glnxa64" -lmwipp -lut -lmwmathutil -lmwsl_simtarget_instrumentation -lmwsl_simtarget_core -lmwsl_fileio -lmwsigstream -lmwslexec_simlog -lmwsl_AsyncioQueue -lmwsf_runtime -lmwsimulink -lmwslexec_simbridge -lmwstringutil -lemlrt -lmwslio_core -lmwslio_clients -lmwsl_services -lmx -lmex
...
MODELLIB                  = Microgrid_with_Utility_Connection_acc.mexa64
MODELREF_LINK_LIBS        = 
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/Microgrid_with_Utility_Connection \
...
Microgrid_with_Utility_Connection_acc.o : $(START_DIR)/slprj/accel/Microgrid_with_Utility_Connection/Microgrid_with_Utility_Connection_acc.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/Microgrid_with_Utility_Connection/Microgrid_with_Utility_Connection_acc.c

Microgrid_with_Utility_Connection_acc_data.o : $(START_DIR)/slprj/accel/Microgrid_with_Utility_Connection/Microgrid_with_Utility_Connection_acc_data.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/Microgrid_with_Utility_Connection/Microgrid_with_Utility_Connection_acc_data.c

rt_nonfinite.o : $(START_DIR)/slprj/accel/Microgrid_with_Utility_Connection/rt_nonfinite.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/Microgrid_with_Utility_Connection/rt_nonfinite.c
